                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('category.edit',$category->id)}}" class="btn btn-primary flex-end">Edit</a>
                                    <a href="#" wire:click="deleteCategory({{$category->id}})"  data-bs-toggle="modal" data-bs-target="#deleteModal" class="btn btn-danger flex-end">Delete</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
